...
Procedure.i Pi3UsbDiagnostic()
  ...
  If p3diag_used<>0 Or Pi3UpdateResetReady()=0 Or Pi3UsbNativeContext()=0
    pi3ut_WriteLine("usbdiag refused: one-shot, confirmed idle updater and cold primary required")
    ProcedureReturn 0
  EndIf
  ...
  If setup<$1100000 Or setup>$1DFFFF8 Or data<$1100000 Or data>$1DFFE00 Or (setup<data+512 And data<setup+8)
    pi3ut_WriteLine("usbdiag refused: resident DMA buffer layout")
    ProcedureReturn 0
  EndIf
  p3diag_used=1
