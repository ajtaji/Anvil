...
`Anvil/Kernel/exceptions.pbi` records AArch64 architectural facts under
...
| `Anvil/Storage/hwfile.pbi` | hardware-facts | vendor-spec | vendor/standards document | cite the document; no notice obligation |
...
| `Anvil/Kernel/exceptions.pbi` | hardware-facts | vendor-spec | vendor/standards document | cite the document; no notice obligation |
