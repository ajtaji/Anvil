...
Each independently built board artifact has a marker in its composition or
loader source:
...
| pi3 | `RaspberryPi3/Board/board.pi3` |
| pi3-loader | `RaspberryPi3/Board/loader.pi3` (diagnostic/recovery target) |
| pi3-updater | `RaspberryPi3/Board/updater.pi3` (diagnostic/recovery target) |
| rockpi4c | `RockPi4C/Board/board.rockpi4c` |
...
| Tool | Builds |
|---|---|
| `tools/build.py` | the requested board artifact: pi3, pi4, unoq, or rockpi4c; `pi3` builds the stub and monitor |
