...
import argparse,hashlib,pathlib,re,struct,sys
...
def main():
    ...
    if bool(args.loader_image)!=bool(args.updater_image):
    ...
    for name,file,load,bss,stack,end,bss_end in [
        ...
        image=(args.loader_image if name=='loader' else args.updater_image) or ROOT/build.TARGETS['pi3-'+name]['output']
