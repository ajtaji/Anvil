...
vkCmdBindIndexBuffer vkCmdBindVertexBuffers vkCmdClearColorImage vkCmdCopyBuffer vkCmdCopyBufferToImage
vkCmdDraw vkCmdDrawIndexed vkCmdEndRenderPass vkCmdFillBuffer
