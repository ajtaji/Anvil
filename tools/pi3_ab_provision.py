#!/usr/bin/env python3
"""Optional legacy A/B recovery provisioning for a Raspberry Pi 3 card.
...
from pi3_boot_stage import BOOT as PINNED_BOOT
...
def check_boot_contract(root: Path, loader: Path, loader_sha256: str) -> None:
    del root, loader, loader_sha256
    raise ProvisionError(
        "A/B provisioning is retired: RaspberryPi3/Boot/config.txt now boots "
        "the complete Anvil kernel8.img directly. Use tools/pi3_provision.py "
        "with a reviewed direct-boot bundle."
    )
