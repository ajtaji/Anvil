...
'''
    with tempfile.TemporaryDirectory(prefix='fat-shared-') as td:
        ...
        for mode in ('flat','wrapper'):
            ...
            # Pin the real pre-extraction source, not today's identical body.
            body=subprocess.check_output(['git','show','fa712c2b5b5becf9f9479730c27e1ba74613c9ac:RaspberryPi4/Lib/fat.pi4'],cwd=ROOT,text=True) if mode=='flat' else 'XIncludeFile "RaspberryPi4/Lib/fat.pi4"\n'
