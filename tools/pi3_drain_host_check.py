...
def main():
    p=argparse.ArgumentParser();p.add_argument('--purebasic',default=str(pathlib.Path.home()/'AppData/Local/Programs/PureBasic/Compilers/pbcompiler.exe'));a=p.parse_args()
