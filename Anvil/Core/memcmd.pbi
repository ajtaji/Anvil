...
Procedure CmdBase()
  ...
  Else
    ...
    PrintN("  It is NOT added by crc32, readback, mtest, load, save, run or")
    PrintN("  autoboot. crc32 is the surprising one and it is deliberate: U-Boot's")
    PrintN("  crc32 does not add it either (v2025.01_cmd_mem.c:1244-1265), and")
    PrintN("  readback is in that family rather than in the display one.")
