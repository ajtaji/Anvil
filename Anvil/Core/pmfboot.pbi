...
;  $00200000 and puts its BSS at $08200000, eight megabytes away, because
;  the two sharing one window was a wall the monitor grew into. A
...
Procedure.i PmfCheckPlacement()
  ...
  If gPmfBssLen > 0
    If PmfCheckRange(gPmfBssBase, gPmfBssBase + gPmfBssLen - 1, "zero-init region") = 0
      ProcedureReturn 0
    EndIf
  EndIf
