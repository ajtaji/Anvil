...
;     XIncludeFile "RaspberryPi4/Board/hw_file.pi4"   ; THIS BOARD's backend
...
;     NEVER calls FatSetBlockWriter - it does not know that such a thing
...
;  with its own machinery. The Pi 4's backend (RaspberryPi4/Board/hw_file.pi4)
