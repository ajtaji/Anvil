...
Procedure vkCmdSetViewport(commandBuffer.i, firstViewport.i, viewportCount.i, *pViewports.VkViewport)
  AnvilVkCmdSetViewport(commandBuffer, firstViewport, viewportCount, *pViewports)
EndProcedure

Procedure vkCmdSetScissor(commandBuffer.i, firstScissor.i, scissorCount.i, *pScissors.VkRect2D)
  AnvilVkCmdSetScissor(commandBuffer, firstScissor, scissorCount, *pScissors)
EndProcedure
...
Procedure vkCmdBindIndexBuffer(commandBuffer.i, buffer.i, offset.i, indexType.i)
  AnvilVkCmdBindIndexBuffer(commandBuffer, buffer, offset, indexType)
EndProcedure
...
Procedure vkCmdDrawIndexed(commandBuffer.i, indexCount.i, instanceCount.i, firstIndex.i, vertexOffset.i, firstInstance.i)
  AnvilVkCmdDrawIndexed(commandBuffer, indexCount, instanceCount, firstIndex, vertexOffset, firstInstance)
EndProcedure
