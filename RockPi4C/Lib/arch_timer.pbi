...
#ROCK_TIMER_FREQUENCY_EXPECTED = 24000000
...
; Portable Anvil wallclock seam for the shared HwFile timestamp path.
Procedure.i Ticks()
  ProcedureReturn RockTimerTicks()
EndProcedure

Procedure.i TickHz()
  ProcedureReturn rock_timer_frequency
EndProcedure
