; EL3 vector foundation. Every slot captures the architectural fault record
...
ProcedureNaked RockExceptionFatal()
  ASM
    ...
    ; Keep the exact FTDI recovery parser alive on the emergency stack
...
Procedure.i RockExceptionInstall()
  If rock_current_el <> 12 Or rock_exception_active <> 0
    ProcedureReturn 0
  EndIf
